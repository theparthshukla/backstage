...
import {
  ...
  RELATION_DATA_PROVIDED_BY,
  RELATION_DATA_CONSUMED_BY,
  RELATION_CHILD_OF,
  RELATION_PROVIDES_DATA,
  RELATION_CONSUMES_API,
  RELATION_CONSUMES_DATA,
...
export const ALL_RELATION_PAIRS: RelationPairs = [
  ...
  [RELATION_DATA_PROVIDED_BY, RELATION_PROVIDES_DATA],
  [RELATION_CONSUMES_DATA, RELATION_DATA_CONSUMED_BY],
